...
.bg-img {
  /* The image used */
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)),url("adminpic.jpg");
...
<form class="text-center border border-light p-5" method="post" action="RegistrationController_Admin">

<br>
<br>
<br>
<br>
 <p class="h4 mb-4">Admin Registration</p>
<br>
